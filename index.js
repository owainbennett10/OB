window.onscroll = () => {
  ...
  if(this.scrollY <= 10) return; else nav.className = 'scroll';
else if(this.scrollY <= 10) return; 
    nav.className.remove = 'scroll';
};
// nav state
      var showMobileNav = false;
      var navToggleBtn = document.getElementById("nav-items");
